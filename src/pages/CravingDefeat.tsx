...
const CravingDefeat = () => {
  ...
  return (
    <div className="bg-kinetic-surface text-kinetic-on-surface min-h-screen overflow-hidden flex flex-col">
      ...
      <main className="flex-1 relative flex flex-col items-center justify-center px-6 overflow-hidden pt-24">
        ...
        <div className="relative z-10 w-full max-w-lg text-center">
          ...
          <div className="relative mb-12 inline-block">
            {/* Outer Ring */}
            <div className="w-48 h-48 rounded-full border-4 border-kinetic-surface-container-highest flex items-center justify-center relative">
              {/* Progress Arc */}
              ...
              {/* Center Badge */}
              <div className="w-36 h-36 rounded-full bg-kinetic-surface-container-high flex flex-col items-center justify-center shadow-2xl">
                <span className="font-headline text-5xl font-black text-kinetic-primary tracking-tighter">
                  +1
                </span>
          ...
          <div className="space-y-4 mb-16">
            <h1 className="font-headline text-5xl md:text-6xl font-black tracking-tighter leading-none">
              Craving{" "}
              <span className="text-kinetic-primary italic">defeated</span>{" "}
              <span className="inline-block animate-bounce">🔥</span>
            </h1>
            <p className="font-body text-kinetic-on-surface-variant text-lg max-w-xs mx-auto opacity-80 leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-4 mb-16">
            <div className="bg-kinetic-surface-container-low p-6 rounded-xl text-left border-l-4 border-kinetic-primary/20">
            ...
            <div className="bg-kinetic-surface-container-low p-6 rounded-xl text-left border-l-4 border-kinetic-secondary/20">
              <p className="font-label text-[10px] uppercase tracking-widest text-kinetic-on-surface-variant mb-2">
                Willpower
              </p>
              <p className="font-headline text-2xl font-bold text-kinetic-on-surface">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-kinetic-primary to-kinetic-primary-container py-5 rounded-xl text-kinetic-on-primary font-headline font-bold text-lg shadow-[0_16px_32px_rgba(var(--kinetic-primary)/0.15)] active:scale-95 transition-all hover:shadow-[0_20px_40px_rgba(var(--kinetic-primary)/0.25)]"
          >
            Back to Dashboard
          </button>
